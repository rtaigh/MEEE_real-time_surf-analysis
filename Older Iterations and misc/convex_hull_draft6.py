...
cap = cv2.VideoCapture('masters_Video_cap/19_1_2019_1.mp4')#6_1_2018_3.mp4')#28_12_2018_8.mp4')#29_12_2018_0.mp4')#'6_1_2018_4.mp4')#19_1_2019_1.mp4')#'My Video1.mp4')#     ITERATION THEN SHIFT AMOUNT
    ...
    for contour in contours:
          ...
          if wcon>40 and wcon*hcon>100:#width/10 :#and hcon<30:
             ...
             # old_local=local
              ...
              if Swell==True and break_==True and min_line>one and max_line>one:
                  print('clean_Wave')
                  Swell=False
                  break_=False
